        ...
        <h1  class="blue">用户注册</h1>
          <dl>
            <dd>
              ...
              <input name="user.username" type="text" class="inputh lf" value="${registerUser.username}" />
              <s:fielderror fieldName="user.username"></s:fielderror>
              <div class="lf red laba">用户名要求不低于6个字符</div>
            </dd>
            <dd>
              <label> <small>*</small>密码</label>
              <input name="user.userpassword" type="text" class="inputh lf" value="${registerUser.userpassword}" />
               <s:fielderror fieldName="user.userpassword"></s:fielderror>
              <div class="lf red laba">密码要求不低于6个字符</div>
            </dd>
            <dd>
              <label> <small>*</small>身份证号</label>
              <input name="user.usercardno" type="text" class="inputh lf" value="${registerUser.usercardno}" />
               <s:fielderror fieldName="user.usercardno"></s:fielderror>
              <div class="lf red laba">身份证号必填</div>
            </dd>
            <dd>
              <label> <small>*</small>电话</label>
              <input name="user.usertel" type="text" class="inputh lf" value="${registerUser.usertel}" />
               <s:fielderror fieldName="user.usertel"></s:fielderror>
              <div class="lf red laba">电话号码必填</div>
            </dd>
            <dd>
              <label> <small>*</small>住址</label>
              <input name="user.useraddress" type="text" class="inputh lf" value="${registerUser.useraddress}" />
            </dd>
            <dd>
              <label> <small>*</small>邮政编码</label>
              <input name="user.userpostnumber" type="text" class="inputh lf" value="${registerUser.userpostnumber}" />
            </dd>
            <dd class="hegas">
