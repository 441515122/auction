...
<body>
	<div class="all">
		...
		<div>
			...
			<form action="updateAction.action" enctype="multipart/form-data"
				method="post">
				<input type="hidden" name="auction.auctionid" value="${auction.auctionid}">
				<label class="name">名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称</label><input
					id="form"  placeholder="名称" name="auction.auctionname" value="<s:property value="auction.auctionname"/>"
					class="form-control" type="text"> <label class="name1">起拍价</label><input
					id="form1"  placeholder="起拍价" name="auction.auctionstartprice" value="<s:property value="auction.auctionstartprice"/>" 
					class="form-control" type="text"> <label class="name">底&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价</label><input
					id="form"  placeholder="底价" name="auction.auctionupset" value="<s:property value="auction.auctionupset"/>"
					class="form-control" type="text"> <label class="starttime">开始时间</label><input
					id="form1"  placeholder="开始时间" name="auction.auctionstarttime" value="<s:date name="auction.auctionstarttime" format="yyyy-MM-dd hh:mm:dd"/>" onclick="selectDate(this,'yyyy-MM-dd hh:mm:ss')"
					class="form-control" type="text"> <label class="endtime">结束时间</label><input
					id="form"  placeholder="结束时间" name="auction.auctionendtime" value="<s:date name="auction.auctionendtime" format="yyyy-MM-dd hh:mm:dd"/>" onclick="selectDate(this,'yyyy-MM-dd hh:mm:ss')" onclick="selectDate(this,'yyyy-MM-dd hh:mm:ss')"
					class="form-control" type="text"> <label class="name3">拍卖品图片</label>
					<div id="imagePreview" >
                	<img id="imgid" src="upload/<s:property value="auction.auctionpictype"/>" width="100" height="100" style="border-radius: 5px;"/>
                </div>
				<div class="loadImage">
				...
				<textarea placeholder="描述" id="ptext" class="form-control" name="auction.auctiondesc"><s:property value="auction.auctiondesc"/></textarea>
